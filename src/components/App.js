...
import blwNFT from '../images/blwNFT.png'
import './App.css'

// Import ABI + Config
import OpenEmoji from '../abis/BeLikeWater.json';
			...
			<main>
				<Row className="my-3">
					<Col className="text-center">
						<h1 className="text-uppercase">Be Like Water</h1>
						<p className="countdown">
							{revealTime !== 0 && <Countdown date={currentTime + (revealTime - currentTime)} />}
						</p>
						<p>Welcome! Mint your NFT (not including gas fees) on 2/26/22</p>
					</Col>
				</Row>
				<Row className="my-4">
